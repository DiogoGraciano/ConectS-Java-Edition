...
public class dialogTerminal extends javax.swing.JDialog {

    private DaoTerminal dao = new DaoTerminal();
    //limpar componentes
    //criar objeto
    private Terminal getTerminal(){
        ...
        if (textCodigo.getText().isEmpty()){
            ...
            t.setId(Integer.parseInt(textCodigo.getText()));
        }       
        t.setNome(textNome.getText());
        return t;
    }
    
    private void atualizaComponentes(Terminal t){
        textCodigo.setText(t.getId()+"");
    ...
    public dialogTerminal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void listaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listaMouseClicked
        if (evt.getClickCount() == 2){
            Terminal s = (Terminal)lista.getSelectedValue();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialogTerminal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogTerminal dialog = new dialogTerminal(new javax.swing.JFrame(), true);
