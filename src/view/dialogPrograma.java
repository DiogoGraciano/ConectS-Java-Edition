...
public class dialogPrograma extends javax.swing.JDialog {

    private DaoPrograma dao = new DaoPrograma();
    //limpar componentes
    //criar objeto
    ...
    private void atualizaComponentes(Programa p){
    ...
    public dialogPrograma(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void listaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listaMouseClicked
        if (evt.getClickCount() == 2){
            Programa p = (Programa)lista.getSelectedValue();
            this.atualizaComponentes(p);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialogPrograma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogPrograma dialog = new dialogPrograma(new javax.swing.JFrame(), true);
